module.exports = {
  ...
  async execute(interaction) {
    const lines = [
      ...
      '`/analyze bullish` — All 18 LLMs vote bullish or bearish on an asset.',
      '`/analyze multival` — Up to 8 models estimate market cap at a target date.',
      '`/analyze soloval` — One model runs multiple valuations — shows distribution.',
      '`/analyze technical` — Up to 8 models analyze a chart screenshot — long or short.',
      '',
      '**━━━ Post Fiat Suite ━━━**',
