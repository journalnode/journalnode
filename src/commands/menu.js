module.exports = {
  ...
  async execute(interaction) {
    const lines = [
      ...
      '`/llmanalyze bullish` — All 18 LLMs vote bullish or bearish on an asset.',
      '`/llmanalyze multival` — Up to 8 models estimate market cap at a target date.',
      '`/llmanalyze soloval` — One model runs multiple valuations — shows distribution.',
      '`/llmanalyze technical` — Up to 8 models analyze a chart screenshot — long or short.',
      '',
      '**━━━ Post Fiat Suite ━━━**',
