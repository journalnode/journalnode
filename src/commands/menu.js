module.exports = {
  ...
  async execute(interaction) {
    const lines = [
      ...
      '`/hyperliquid add` — Add a new Hyperliquid wallet.',
      '`/hyperliquid rename` — Rename a connected wallet.',
      '`/hyperliquid wallets` — List all connected wallets.',
      '`/hyperliquid remove` — Remove a connected wallet.',
      '`/hyperliquid status` — Check connection status.',
      '',
      '**━━━ Post Fiat Suite ━━━**',
